...
public class DiscusschepiaoxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscusschepiaoxinxiEntity discusschepiaoxinxi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscusschepiaoxinxiEntity discusschepiaoxinxi, HttpServletRequest request){
        EntityWrapper<DiscusschepiaoxinxiEntity> ew = new EntityWrapper<DiscusschepiaoxinxiEntity>();
    	PageUtils page = discusschepiaoxinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discusschepiaoxinxi), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
    ...
    public R save(@RequestBody DiscusschepiaoxinxiEntity discusschepiaoxinxi, HttpServletRequest request){
    	discusschepiaoxinxi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscusschepiaoxinxiEntity> wrapper = new EntityWrapper<DiscusschepiaoxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discusschepiaoxinxiService.selectCount(wrapper);
